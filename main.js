...
for (let i = 0; i < tracks.length; i += 1) {
  ...
  play.src = _images_play_svg__WEBPACK_IMPORTED_MODULE_11__;
  play.style.height = '30px';
  play.style.width = '30px';

  // creat pause button
  const pause = new Image();
  pause.src = _images_pause_svg__WEBPACK_IMPORTED_MODULE_12__;
